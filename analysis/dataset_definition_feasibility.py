...
## First Viral fatigue code in primary care
...
dataset.cov_date_t2dm_original = minimum_of(
...
dataset.cov_date_t1dm_original = minimum_of(
...
dataset.cov_date_gestationaldm_original = minimum_of(
...
## HbA1c
# Maximum HbA1c measure (in period before feasibilityend_date)
...
# Identify first date (in period before feasibilityend_date) that any diabetes medication was prescribed
...
# Identify first date (in period before feasibilityend_date) that any diabetes diagnosis codes were recorded
