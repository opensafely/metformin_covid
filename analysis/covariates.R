...
####
covariates_names <- c("cov_cat_sex", "cov_num_age_spline", "strat_cat_region",
                       ...
                       "cov_num_counthba1c",
                       "cov_cat_bmi_groups", "cov_cat_tc_hdl_ratio_b", "cov_num_hba1c_log_b", "cov_num_period_month")
...
covariates_tv_names <- c("cov_cat_sex", "cov_num_age_spline", "strat_cat_region",
