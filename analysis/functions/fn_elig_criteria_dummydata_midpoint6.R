...
################################################################################
fn_elig_criteria_dummydata_midpoint6 <- function(data_processed, study_dates, years_in_days) {
  ...
  data_processed <- data_processed %>%
    mutate(
      ...
      # | (elig_date_t2dm < mid2018_date - days(years_in_days)) ### commented out to allow more dummydata!
      )
