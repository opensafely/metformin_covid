fn_diabetes_algorithm <- function(data_extracted){
  data_extracted <- data_extracted %>%
    ...
    mutate(tmp_cov_year_first_diabetes_diag = as.integer(format(tmp_cov_date_first_diabetes_diag,"%Y")),
           tmp_age_1st_diag = tmp_cov_year_first_diabetes_diag - qa_num_birth_year,
